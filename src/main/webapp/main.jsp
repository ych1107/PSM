...
<link rel="stylesheet" type="text/css" href="skin/css/main.css" />
	...
	<script type="text/javascript">
		$(function () {
			$.ajax({
				url:"${pageContext.request.contextPath}/notice/getNews",
				type: "get",
				success:function (msg) {
					$(msg.map.list).each(function (index, item) {
						var li = "<li class='ue-clear'>" +
								"<span>"+getMyDate(item.ndate)+"</span>&nbsp;&nbsp;&nbsp;<a onclick='showWindow("+item.nid+")' href='#' class='notice-title'>"+item.ntitle+"</a>" +
								"</li>"+
								"<p>";
						$("#notices").append(li);
					})
			...
			$.ajax({
				url:"${pageContext.request.contextPath}/task/taskStatus",
				type: "get",
				success:function (msg) {
					$("#taskStatus").text(msg);
				}
		...
		function showWindow(obj) {
			var nid = obj;
			$.ajax({
				url:"${pageContext.request.contextPath}/notice/getOne",
				type: "get",
				data:{"nid": nid},
				success:function (msg) {
...
<div id="showdiv" style="width: 60%; margin: 0 auto; height:500px; border: 1px solid #999; display: none; position: absolute; top: 20%; left: 20%; z-index: 3; background: #fff">
	...
	<table width="98%" align="center" border="0" cellpadding="3"
		...
		<tr bgcolor="#FFFFFF">
			<td>您有<a href=""><font color="red" id="taskStatus">2</font></a>个任务未完成……&nbsp;
			</td>
		</tr>
	</table>
