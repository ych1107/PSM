...
<%--			<li><a href='${pageContext.request.contextPath}/mybaoxiao-base.jsp' target='main'>我的报销</a> </li>--%>
			<li><a href='${pageContext.request.contextPath}/forumPost.jsp' target='main'>发送帖子</a> </li>
		</ul>
	</dd>
</dl>
...
<dl class='bitem'><dt onclick=showHide("items4_1")><b>客户信息管理</b></dt>
	<dd style='display:none' class='sitem' id=items4_1>
		<ul class='sitemu' id=3>
			<li><a href='${pageContext.request.contextPath}/cust/searchBypage' target='main'>客户信息</a> </li>
		</ul>
	</dd>
</dl>

<dl class='bitem'><dt onclick=showHide("items5_1")><b>系统管理</b></dt><dd style='display:none' class='sitem' id=items5_1>
		<ul class='sitemu' id=4>
<%--			<li><a href='user.jsp' target='main'>人员管理</a> </li>--%>
			<li><a href='pm.jsp' target='main'>权限管理</a> </li>
<%--			<li><a href='role.jsp' target='main'>角色管理</a> </li>--%>
		</ul>
	</dd>
</dl>

			<dl class='bitem'><dt onclick=showHide("items6_1")><b>对标管理</b></dt>
				<dd style='display:none' class='sitem' id=items6_1>
					<ul class='sitemu' id=5>
						<li><a href='indexvalue-add.jsp' target='main'>对标信息管理</a></li>
						<li><a href='indexvalue-base.jsp' target='main'>数据统计</a> </li>
					</ul>
				</dd>
			</dl>

<dl class='bitem'><dt onclick=showHide("items7_1")><b>我的信息</b></dt>
