...
<title>功能管理</title>
   <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/skin/css/base.css">
    ...
    <script type="text/javascript">
        $(function () {
            $.ajax({
                url: "${pageContext.request.contextPath}/fun/list",
                type: "get",
                success:function (msg) {
                    $(msg).each(function (index, item) {
                        ...
                        +" <td align='center'><a href=''><u>"+item.analysisname+"</u></a></td>"
                        +" <td align='center'><a href=''><u>"+item.proname+"</u></a></td>"
                        +"  <td>"+item.level+"</td>"
                        +"  <td>2015-02-03</td>"
                        +"  <td>2015-06-03</td>"
                        +"  <td><a href='project-function-edit.jsp?id="+item.id+"'>编辑</a> | <a href='project-function-look.jsp?id="+item.id+"'>查看详情</a></td>"
                        +"  </tr>"
                        $("#mark").before(tr);
                    })
                }
        ...
        function batchdel() {
            ...
            $.ajax({
                url:"${pageContext.request.contextPath}/fun/batchdel",
                type:"post",
        ...
        function search() {
            ...
            $("[name=addtr]").remove()
            $.ajax({
                url:"${pageContext.request.contextPath}/fun/search",
                type:"post",
