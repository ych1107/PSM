...
<script type="text/javascript">
	$(function () {
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/sour/getOne/"+sid,
			type: "get",
...
<!--  内容列表   -->
<form name="form2" id="form14" action="${pageContext.request.contextPath}/sour/edit" method="post">
   <input type="hidden" id="sid" name="id" value="${param.id}">
