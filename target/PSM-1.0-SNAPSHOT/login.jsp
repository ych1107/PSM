...
<script type="text/javascript">
	function changeImg() {
		$("#changes").attr("src", "${pageContext.request.contextPath}/code/getCode?time=" + (new Date().getTime()));
	}
	function login(){
		$("#form1").submit();
	}
...
<BODY bgColor=#eef8e0 leftMargin=0 topMargin=0 MARGINWIDTH="0"
	MARGINHEIGHT="0">
	<!--8888 -->
	<form id="form1" action="${pageContext.request.contextPath}/emp/login" method="post">
										...
										<TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt value="cy135" title=请填写用户名 maxLength=16
														size=16  name=username></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt value="123456" title=请填写密码 type=password
												...
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写验证码 maxLength=50
														size=16 name='code' value="${message}"><img id="changes" onclick="changeImg()" src="${pageContext.request.contextPath}/code/getCode?time="+(new Date().getTime()) alt=""></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
