        ...
        $.ajax({
            ...
            success:function(msg){
            	$(msg).each(function (index,item){
					$("#emps").append("<option value='"+item.eid+"'>"+item.ename+"</option>");
				})
            }
        });
    });
...
<form id="form1" action="${pageContext.request.contextPath}/info/saveInfo" enctype="multipart/form-data" method="post">
...
<tr >
	...
	<tr >
		...
		<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
			<input class="Wdate" name="sendtime" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})"/></td>
	</tr>
<tr >
